...
(
	...
	"Опыт_работы" NUMBER(10) NOT NULL,

	"Личные_качества" NVARCHAR2(255) NOT NULL,

	"Вакансия" NVARCHAR2(255) NOT NULL,
